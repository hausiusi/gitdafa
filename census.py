...
class Statistics(object):
    ...
    async def async_parse_authors(self, commit_from, commit_to):
        ...
        #print(commit_from, commit_to, self.task_count, '----2----')
    ...
    def parse_authors(self):
        ...
        cmd_output.cmd = None
        print('*' * 100)
        print(self.commits_count)
        print('*' * 100)
        for i in range(0, self.commits_count, self.parse_step_len):
            #current_step = min(self.parse_step_len + i, self.commits_count - i)
            current_step = self.parse_step_len + i
            loop = asyncio.get_event_loop()
            print(i, current_step, '----1----')
